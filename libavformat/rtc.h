 ...
 */
#define RTC_ICE_STUN_HEADER_SIZE 20
...
typedef struct RTCContext {
    ...
    char *sdp_answer;
    /* The resource URL returned in the Location header of the HTTP response. */
    char *resource_url;
    /**
...
int ff_rtc_certificate_key_init(RTCContext *rtc);
int ff_rtc_dtls_initialize(RTCContext *rtc);
